...
##################################################################
   ...
   # BLG 4ko de STACK .comm InitStack, 512
   #.comm InitStack, 4096
   .comm InitStack, 16384
...
entry:
   ...
   la    $4, _end             #$2 = .bss_end
   # BLG 4ko de STACKla    $sp, InitStack+488   #initialize stack pointer
   #la    $sp, InitStack+(4096-24) #+488   #initialize stack pointer
   la    $sp, InitStack+(16384-24) #+488   #initialize stack pointer
