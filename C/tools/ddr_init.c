...
int main()
{
   ...
   int i,y;
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
   puts("- Initialisation de la memoire DDR\n");
   DdrInit();
   puts("  + Initialisation OK\n");

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
   puts("- Test de lecture et ecriture a l'adresse de base\n");
   ptr[0] = 0x12345678;
   if(ptr[0] != 0x12345678)
      putchar('X');
   puts("  + Test passe avec succès\n");

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
   puts("- Test d'écriture dans la mémoire\n");
	int pattern[] = {0x00, 0xFFFFFFFF, 0xFF00FF00, 0x00FF00FF, 0xF0F0F0F0};
	unsigned int TEST_LENGTH = 1024*1024/4;
   for(y=0; y<1024; y++){ 
		unsigned int adr_start = ptr;
		unsigned int adr_stop  = &ptr[TEST_LENGTH];
   	puts("  + @dr testing (1Mo) from 0x"); print_hex( adr_start ); puts(" to 0x"); print_hex( adr_stop ); puts("\n");
